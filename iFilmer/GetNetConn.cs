...
namespace IsNetworkAvailable
{
    ...
    public class IsAvailable
    {
        ...
        ///     <c>true</c> if a network connection is available; otherwise, <c>false</c>.
        /// </returns>
        public static bool Available(long minimumSpeed)
        {
        ...
        /// </returns>
        public string PingHost(string HostnameorAddress)
        {
            try
            {
        ...
        /// <c>error message</c>if ip address or host name is invalid or network connection is unavailable: otherwise, <c>success</c>.
        /// </returns>
        public string PingHost(IPAddress IPaddress)
        {
            try
            {
                var ping = new System.Net.NetworkInformation.Ping();
